...
TEST(processDueAtDate, setDueDate1day) {
    ...
    auto due = nextapp::grpc::GrpcServer::processDueAtDate(toTimet(2024_y/February/29),
                                                           ::nextapp::pb::Action_RepeatUnit::Action_RepeatUnit_DAYS,
                                                           ::nextapp::pb::ActionDueKind::DATETIME,
                                                           1,
                                                           uctx_sunday_fdow);
...
TEST(processDueAtDate, setDueDate1Week) {
    ...
    auto due = nextapp::grpc::GrpcServer::processDueAtDate(toTimet(2024_y/February/29),
                                                           ::nextapp::pb::Action_RepeatUnit::Action_RepeatUnit_WEEKS,
                                                           ::nextapp::pb::ActionDueKind::DATETIME,
                                                           1,
                                                           uctx_sunday_fdow);
...
TEST(processDueAtDate, setDueDate1Month) {
    ...
    auto due = nextapp::grpc::GrpcServer::processDueAtDate(toTimet(2023_y/December/31),
                                                           ::nextapp::pb::Action_RepeatUnit::Action_RepeatUnit_MONTHS,
                                                           ::nextapp::pb::ActionDueKind::DATETIME,
                                                           1,
                                                           uctx_sunday_fdow);
...
TEST(processDueAtDate, setDueDate1QuarterFromJanuary) {
    ...
    auto due = nextapp::grpc::GrpcServer::processDueAtDate(toTimet(2024_y/January/13),
                                                           ::nextapp::pb::Action_RepeatUnit::Action_RepeatUnit_QUARTERS,
                                                           ::nextapp::pb::ActionDueKind::DATETIME,
                                                           1,
                                                           uctx_sunday_fdow);
...
TEST(processDueAtDate, setDueDate1Year) {
    ...
    auto due = nextapp::grpc::GrpcServer::processDueAtDate(toTimet(2023_y/December/31),
                                                           ::nextapp::pb::Action_RepeatUnit::Action_RepeatUnit_YEARS,
                                                           ::nextapp::pb::ActionDueKind::DATETIME,
                                                           1,
                                                           uctx_sunday_fdow);
...
TEST(processDueAtDayspec, setMondayAtMonday) {
    ...
    const int val = 1 << ::nextapp::pb::Action_RepeatSpecs::Action_RepeatSpecs_MONDAY;
...
TEST(processDueAtDayspec, setTuesdayAtMonday) {
    ...
    const int val = 1 << ::nextapp::pb::Action_RepeatSpecs::Action_RepeatSpecs_TUESDAY;
    const auto from = toTimet(2024_y/March/Monday[1]);
...
TEST(processDueAtDayspec, setWednesdayAtMonday) {
    ...
    const int val = 1 << ::nextapp::pb::Action_RepeatSpecs::Action_RepeatSpecs_WEDNESDAY;
    const auto from = toTimet(2024_y/March/Monday[1]);
...
TEST(processDueAtDayspec, setThursdayAtMonday) {
    ...
    const int val = 1 << ::nextapp::pb::Action_RepeatSpecs::Action_RepeatSpecs_THURSDAY;
    const auto from = toTimet(2024_y/March/Monday[1]);
...
TEST(processDueAtDayspec, setFridayAtMonday) {
    ...
    const int val = 1 << ::nextapp::pb::Action_RepeatSpecs::Action_RepeatSpecs_FRIDAY;
    const auto from = toTimet(2024_y/March/Monday[1]);
...
TEST(processDueAtDayspec, setSaturdayAtMonday) {
    ...
    const int val = 1 << ::nextapp::pb::Action_RepeatSpecs::Action_RepeatSpecs_SATURDAY;
    const auto from = toTimet(2024_y/March/Monday[1]);
...
TEST(processDueAtDayspec, setSundayAtMonday) {
    ...
    const int val = 1 << ::nextapp::pb::Action_RepeatSpecs::Action_RepeatSpecs_SUNDAY;
    const auto from = toTimet(2024_y/March/Monday[1]);
...
TEST(processDueAtDayspec, setFirstDayOfWeekAtMonday) {
    ...
    const int val = 1 << ::nextapp::pb::Action_RepeatSpecs::Action_RepeatSpecs_FIRST_DAY_IN_WEEK;
...
TEST(processDueAtDayspec, setLastDayOfWeekAtMonday) {
    ...
    const int val = 1 << ::nextapp::pb::Action_RepeatSpecs::Action_RepeatSpecs_LAST_DAY_OF_WEEK;
    const auto from = toTimet(2024_y/March/4);
...
TEST(processDueAtDayspec, setFirstDayOfMonthAtMonday) {
    ...
    const int val = 1 << ::nextapp::pb::Action_RepeatSpecs::Action_RepeatSpecs_FIRST_DAY_IN_MONTH;
    const auto from = toTimet(2024_y/March/4);
...
TEST(processDueAtDayspec, setLastDayOfMonthAtChristmas) {
    ...
    const int val = 1 << ::nextapp::pb::Action_RepeatSpecs::Action_RepeatSpecs_LAST_DAY_IN_MONTH;
    const auto from = toTimet(2024_y/December/24);
...
TEST(processDueAtDayspec, setFirstDayInQuarterAtJanuary) {
    ...
    const int val = 1 << ::nextapp::pb::Action_RepeatSpecs::Action_RepeatSpecs_FIRST_DAY_IN_QUARTER;
...
TEST(processDueAtDayspec, setLastDayInQuarterAtJanuary) {
    ...
    const int val = 1 << ::nextapp::pb::Action_RepeatSpecs::Action_RepeatSpecs_LAST_DAY_IN_QUARTER;
    const auto from = toTimet(2024_y/January/10);
...
TEST(processDueAtDayspec, setFirstDayInYear) {
    ...
    const int val = 1 << ::nextapp::pb::Action_RepeatSpecs::Action_RepeatSpecs_FIRST_DAY_IN_YEAR;
    const auto from = toTimet(2024_y/April/last);
    const auto valid = toTimet(2025_y/January/1);
...
TEST(processDueAtDayspec, setLastDayInYear) {
    ...
    const int val = 1 << ::nextapp::pb::Action_RepeatSpecs::Action_RepeatSpecs_LAST_DAY_IN_YEAR;
    const auto from = toTimet(2024_y/April/last);
...
std::unique_ptr<UserContext> createUserContext(bool sundayIsFirstWeekday = false, string_view timeZoneName = chrono::current_zone()->name()) {
    static jgaa::mysqlpool::Options dbo;
    return std::make_unique<UserContext>("", "", std::string{timeZoneName}, sundayIsFirstWeekday, dbo);
}
...
TEST(TimePeriod, someWeekMonday) {
    ...
    auto tp = nextapp::grpc::toTimePeriodWeek(when, *uctx);
