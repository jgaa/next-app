...
Dialog {
    ...
    height: ApplicationWindow.window !== null ? Math.min(ApplicationWindow.window.height - 10, 900) : 100
    ...
    ScrollView {
        id: scrollView
        anchors.fill: parent
        contentWidth: contentLayout.width    // The important part
        contentHeight: contentLayout.height  // Same
